...
class DegreePlanMap(Base):
    ...
    notes: Mapped[dict] = mapped_column(JSONB, default={}, nullable=True)
    corecourses: Mapped[dict] = mapped_column(JSONB, default={}, nullable=True)
    concentrations: Mapped[dict] = mapped_column(JSONB, default={}, nullable=True)